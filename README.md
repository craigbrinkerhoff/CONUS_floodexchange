...
`run.sh` will launch a non-interactive R session and run the pipeline specifications in `src/runTargets.R`. It is written specifically for our SLURM scheduler- your HPC will required different resource settings than our's.
